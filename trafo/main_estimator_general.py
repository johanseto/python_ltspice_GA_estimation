...
simu_data=SimulationInfo(netlist_path,sim_raw,parameters,signals,norm=True)
...
prueba=np.array([[0,1,1000,0.01,1,0.01]])

dist1= fitnessGeneral(prueba)


simu_data=SimulationInfo(netlist_path,sim_raw,parameters,signals)
#simu_data.netlistGen(netlist_path,parameters)
